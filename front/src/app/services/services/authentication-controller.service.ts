...
import { sendEmail } from '../fn/authentication-controller/send-email';
import { SendEmail$Params } from '../fn/authentication-controller/send-email';
...
export class AuthenticationControllerService extends BaseService {
  ...
  static readonly SendEmailPath = '/auth/sendEmail';
