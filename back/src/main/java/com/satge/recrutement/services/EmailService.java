...
//        MimeMessageHelper helper = new MimeMessageHelper(message);
    ...
    public void sendStatusChangeEmail(Candidature candidature, String customMessage) {
        String subject = "Your Application Status Has Changed";
//        String recipient = condidature.getUser().getEmail();
        String content = createEmailContent(candidature, customMessage);
        sendEmailEtat("latifa.benzaied@Esprit.tn", subject, content);
    }


    private String createEmailContent(Candidature candidature, String customMessage) {
        if (customMessage != null && !customMessage.isEmpty()) {
            return customMessage;
        }
        CandidatureStatus status = candidature.getEtat();
        String message = "";
    ...
    public void sendEmailEtat(String to, String subject, String content) {
        MimeMessage message = emailSender.createMimeMessage();
        try {
